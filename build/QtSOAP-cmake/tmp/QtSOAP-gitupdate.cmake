...
execute_process(
  COMMAND "/usr/bin/git" show-ref 914c72959412bfcbaaf0ea9836b0f34258145600
  WORKING_DIRECTORY "/home/yq/work/Practice/CTK/build/QtSOAP"
...
if("${show_ref_output}" MATCHES "refs/remotes/914c72959412bfcbaaf0ea9836b0f34258145600")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "914c72959412bfcbaaf0ea9836b0f34258145600")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "914c72959412bfcbaaf0ea9836b0f34258145600")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 914c72959412bfcbaaf0ea9836b0f34258145600
  WORKING_DIRECTORY "/home/yq/work/Practice/CTK/build/QtSOAP"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/commontk/QtSOAP.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/yq/work/Practice/CTK/build/QtSOAP/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/yq/work/Practice/CTK/build/QtSOAP/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
