...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ctkFileLogger_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ctkFileLogger_t qt_meta_stringdata_ctkFileLogger = {
    {
QT_MOC_LITERAL(0, 13), // "ctkFileLogger"
...
void ctkFileLogger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkFileLogger *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject ctkFileLogger::staticMetaObject = { {
    ...
    qt_meta_stringdata_ctkFileLogger.offsetsAndSize,
    qt_meta_data_ctkFileLogger,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ctkFileLogger_t
, QtPrivate::TypeAndForceComplete<bool, std::true_type>, QtPrivate::TypeAndForceComplete<QString, std::true_type>, QtPrivate::TypeAndForceComplete<ctkFileLogger, std::true_type>
...
void *ctkFileLogger::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkFileLogger.stringdata0))
