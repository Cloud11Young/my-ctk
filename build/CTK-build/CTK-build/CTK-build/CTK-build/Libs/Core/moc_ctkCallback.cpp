...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ctkCallback_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ctkCallback_t qt_meta_stringdata_ctkCallback = {
    {
QT_MOC_LITERAL(0, 11), // "ctkCallback"
QT_MOC_LITERAL(12, 6), // "invoke"
QT_MOC_LITERAL(19, 0) // ""
...
void ctkCallback::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkCallback *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject ctkCallback::staticMetaObject = { {
    ...
    qt_meta_stringdata_ctkCallback.offsetsAndSize,
    qt_meta_data_ctkCallback,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ctkCallback_t
, QtPrivate::TypeAndForceComplete<ctkCallback, std::true_type>
...
void *ctkCallback::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkCallback.stringdata0))
