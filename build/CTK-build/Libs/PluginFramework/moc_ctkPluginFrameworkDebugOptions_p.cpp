...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ctkPluginFrameworkDebugOptions_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ctkPluginFrameworkDebugOptions_t qt_meta_stringdata_ctkPluginFrameworkDebugOptions = {
    {
QT_MOC_LITERAL(0, 30) // "ctkPluginFrameworkDebugOptions"
...
const QMetaObject ctkPluginFrameworkDebugOptions::staticMetaObject = { {
    ...
    qt_meta_stringdata_ctkPluginFrameworkDebugOptions.offsetsAndSize,
    qt_meta_data_ctkPluginFrameworkDebugOptions,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ctkPluginFrameworkDebugOptions_t
, QtPrivate::TypeAndForceComplete<ctkPluginFrameworkDebugOptions, std::true_type>
