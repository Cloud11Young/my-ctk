...
function(_ctk_generate_mocs)
  if(CTK_QT_VERSION VERSION_GREATER "4")
    if(Qt6_VERSION VERSION_LESS "5.15.0")
  ...
  foreach(file ${ARGN})
    ...
    if(CTK_QT_VERSION VERSION_GREATER "4")
      if(Qt6_VERSION VERSION_LESS "5.6")
        QT6_CREATE_MOC_COMMAND(${abs_file} ${moc_file} "${_moc_flags}" "" "")
      elseif(Qt6_VERSION VERSION_LESS "5.15.0")
        QT6_CREATE_MOC_COMMAND(${abs_file} ${moc_file} "${_moc_flags}" "" "" "")
      else()
        # qt6_generate_moc internally calls qt6_get_moc_flags and ensure
        # no warnings are reported.
        qt6_generate_moc(${abs_file} ${moc_file})
      endif()
    else()
